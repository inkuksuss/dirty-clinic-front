...
export default defineComponent({
    ...
    setup() {
        useMeta({
            title: '더티클리닉 - 전문클리닉 - 상가매장청소',
            description: '깔끔함으로 손님들의 마음까지, 상가·매장청소는 더티클리닉에게 맡겨주세요.'
        });
        ...
        const priceList: SubPriceType[] = [
            {
                src: new URL('@/assets/images/sub/price/store.webp', import.meta.url).href,
                ext:
        ...
        const promotionList: SubPromotionType[] = [
            {
                src: new URL('@/assets/images/sub/promotion/store_1.webp', import.meta.url).href
            },
            {
                src: new URL('@/assets/images/sub/promotion/store_2.webp', import.meta.url).href
            }
        ];
