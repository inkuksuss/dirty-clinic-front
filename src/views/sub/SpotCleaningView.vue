...
export default defineComponent({
    components: {PaymentButton, SubBanner, SubPromotion, SubCheckList, SubService, SubManage, SubIntro },
    setup() {
      const store = useStore();
        ...
        const bannerScript = {
            title: '부분청소',
            desc: '청소가 꼭 필요한 부분공간까지,\n부분 청소는 더티클리닉에게 맡겨주세요.'
        };
...
<template>
    <div class="sub-wrapper w-screen flex flex-col items-center justify-start">
        ...
        ></sub-promotion>
        <sub-service main-title="궁금하신 내용을 한눈에 확인하세요." :service-list="serviceScriptList"></sub-service>
