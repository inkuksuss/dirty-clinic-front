...
export default defineComponent({
    ...
    setup() {
        useMeta({
            title: '더티클리닉 - 특수클리닉 - 공장청소',
            description:
                '깨끗하고 운영 가능한 환경을 제공하여 생산 시설의 가치와 직원들의 안전을 향상시킵니다.'
        });
        ...
        const introList: SubIntroType[] = [
            ...
            {
                title: '보양작업 후\n' + '공간 및 설비청소',
                src: new URL('@/assets/images/sub/intro/restoration.webp', import.meta.url).href
            },
            {
                title: '현장 검수 및\n피드백',
        ...
        const promotionList: SubPromotionType[] = [
            {
                src: new URL('@/assets/images/sub/promotion/factory_1.webp', import.meta.url).href
            }
        ];
        ...
        const manageTitle = '공장청소는\n' + '특성상 작업범위가 넓습니다.';
        const manageDesc =
            '전문인력이 현장실측 시 고객님의 피해상황과\n' +
            '작업환경을 고려해 현장에서 안내해 드리고 있습니다.';
        const manageImg = new URL('@/assets/images/sub/manage/factory.webp', import.meta.url).href;

        const bannerScript = {
            title: '공장청소',
            desc:
                '깨끗하고 운영 가능한 환경을 제공하여\n' +
                '생산 시설의 가치와 직원들의 안전을 향상시킵니다.'
        };
...
<template>
    <div class="sub-wrapper w-screen flex flex-col items-center justify-start">
        ...
        <sub-manage
            ...
            :desc="manageDesc"
            :main-img="manageImg"
            :page-type="SubPageType.FACTORY"
        ></sub-manage>
        <sub-promotion :page-type="SubPageType.FACTORY" :prom-list="promotionList"></sub-promotion>
