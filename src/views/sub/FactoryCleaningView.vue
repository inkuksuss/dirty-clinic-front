...
export default defineComponent({
    ...
    setup() {
        ...
        const introList: SubIntroType[] = [
            ...
            {
                title: '보양작업 후\n' + '공간 및 설비청소',
                src: new URL('@/assets/images/sub/intro/restoration.png', import.meta.url).href
            },
            {
                title: '현장 검수 및\n피드백',
        ...
        const manageImg = new URL('@/assets/images/sub/manage/factory.png', import.meta.url).href;
