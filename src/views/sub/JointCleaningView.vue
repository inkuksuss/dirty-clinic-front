...
export default defineComponent({
    ...
    setup() {
        ...
        const promotionList: SubPromotionType[] = [
            {
                src: new URL('@/assets/images/sub/promotion/joint_1.webp', import.meta.url).href
            }
        ];
            ...
            <div class="border-[--color-border-blue] border-[1.5px] p-[30px]">
                <div class="mb-[30px]">
                    ...
                    <div class="desc pl-[30px] text-[--color-black] text-[20px] font-[500]">
                        ...
                        및 반짝이 펄로 인테리어 효과를 줍니다. 황변이나 백화현상 없이 반
                        영구적으로 사용 가능합니다.
                    </div>
                </div>
                <div>
                    ...
                    <div class="desc pl-[30px] text-[--color-black] text-[20px] font-[500]">
                        ...
                        내구성을 바탕으로 난방이 들어오는 거실, 폴리상타일 및 대리석 등에 시공
                        시 효과적입니다. 무광 및 매트한 디자인으로 인테리어 효과가 있습니다.
                    </div>
                </div>
            </div>
        </div>
