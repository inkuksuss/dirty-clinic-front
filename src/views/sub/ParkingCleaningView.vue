...
export default defineComponent({
    ...
    setup() {
        useMeta({
            title: '더티클리닉 - 특수클리닉 - 주차장청소',
            description:
                '최신 기술과 고사양 장비를 사용하여 최고의 전문성을 바탕으로 완성도 높은 결과값을 선사합니다.'
        });
        ...
        const promotionList: SubPromotionType[] = [
            {
                src: new URL('@/assets/images/sub/promotion/parking_1.webp', import.meta.url).href
            }
        ];
        ...
        const bannerScript = {
            ...
            desc:
                '최신 기술과 고사양 장비를 사용하여\n' +
                '최고의 전문성을 바탕으로 완성도 높은 결과값을 선사합니다.'
        };
...
<template>
    <div class="sub-wrapper w-screen flex flex-col items-center justify-start">
        ...
        <sub-manage
            ...
            :desc="manageDesc"
            :main-img="manageImg"
            :page-type="SubPageType.PARKING"
        ></sub-manage>
        <sub-promotion :page-type="SubPageType.PARKING" :prom-list="promotionList"></sub-promotion>
