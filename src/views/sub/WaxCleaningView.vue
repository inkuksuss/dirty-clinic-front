...
export default defineComponent({
    ...
    setup() {
        ...
        const promotionList: SubPromotionType[] = [
            {
                src: new URL('@/assets/images/sub/promotion/wax_1.webp', import.meta.url).href
            }
        ];
        ...
        const bannerScript = {
            title: '바닥왁스 코팅',
            desc: '매끄러움 자체의 아름다움으로 원자재의 보호와 관리를 용이하게 만들어드립니다.'
        };
...
<template>
    <div class="sub-wrapper w-screen flex flex-col items-center justify-start">
        ...
        <sub-manage
            title="어디까지 관리 되나요?"
            :desc="manageDesc"
            :page-type="SubPageType.WAX"
        ></sub-manage>
        <sub-promotion :page-type="SubPageType.WAX" :prom-list="promotionList"></sub-promotion>
