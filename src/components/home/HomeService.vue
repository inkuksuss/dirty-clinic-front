        ...
        <div class="service-contents w-full">
            ...
            <div class="contents-wrapper grid grid-cols-2 gap-x-[20px]">
                <div v-for="(script, idx) in scriptList" :key="idx">
                    <clinic-image
                        :src="script.src"
                        class="service-img w-full mb-[25px]"
                    ></clinic-image>
