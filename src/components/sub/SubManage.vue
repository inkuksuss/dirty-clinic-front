        ...
        const manageList = ref<ManageInfo[]>([
            {
                ...
                icon: '/dirty-clinic-front/src/assets/images/icons/living_room.svg',
                isOpen: false
            },
            {
                title: '화장실, 욕실',
                ...
                icon: '/dirty-clinic-front/src/assets/images/icons/bath_room.svg',
                isOpen: false
            },
            {
                title: '주방',
                ...
                icon: '/dirty-clinic-front/src/assets/images/icons/kitchen.svg',
                isOpen: false
            },
            {
                title: '베란다, 다용도실',
                ...
                icon: '/dirty-clinic-front/src/assets/images/icons/veranda.svg',
                isOpen: false
            },
            {
                title: '방',
                ...
                icon: '/dirty-clinic-front/src/assets/images/icons/room.svg',
                isOpen: false
            },
            {
                title: '현관',
                ...
                icon: '/dirty-clinic-front/src/assets/images/icons/entrance.svg',
                isOpen: false
            }
        ]);
