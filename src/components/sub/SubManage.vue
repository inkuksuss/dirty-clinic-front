...
<template>
    <div
        class="manage-wrapper bg-[--color-skyblue] w-full pt-[85px] pb-[85px] flex flex-col items-center"
    >
        ...
        <div class="list-area grid grid-rows-3 grid-cols-2 gap-[20px]">
            ...
            >
                <div class="body flex items-center">
                    ...
                    <span class="text-[--color-text-black] text-[24px] font-[600] leading-[26px]">{{
                        info.title
                    }}</span>
                </div>
