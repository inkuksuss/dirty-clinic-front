        ...
        const manageList = ref<ManageInfo[]>([
            {
                ...
                icon: '@/assets/images/icons/living_room.svg',
                isOpen: false
            },
            {
                title: '화장실, 욕실',
                ...
                icon: '@/assets/images/icons/bath_room.svg',
                isOpen: false
            },
            {
                title: '주방',
            ...
            },
            {
                ...
                icon: '@/assets/images/icons/veranda.svg',
                isOpen: false
            },
            {
                title: '방',
                ...
                icon: '@/assets/images/icons/room.svg',
                isOpen: false
            },
            {
                title: '현관',
                ...
                icon: '@/assets/images/icons/entrance.svg',
                isOpen: false
            }
        ]);
